...
public class AttachedTimedMessage extends TimedMessage {
    ...
    public AttachedTimedMessage(String text, BitmapFont font, Color textColor, TextureRegion background, long millisecondsToShow, GameObject target, Vector3 relativePosition) {
        super(text, font, textColor, background, millisecondsToShow, target.getPosition());
